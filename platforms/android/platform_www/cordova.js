 ...
 * onDestroy*                  Internal event fired when controllerModule is being destroyed (User should use window.onunload event, not this one).
 *
...
module.exports = {
    ...
    bootstrap: function() {
        ...
        modulemapper.clobbers('cordova/plugin/android/controllerModule', 'navigator.controllerModule');
...
// file: src/android/plugin/android/ticketController.js
define("cordova/plugin/android/controllerModule", function(require, exports, module) {
...
module.exports = {
    ...
    *
    * Example:
    *      navigator.controllerModule.loadUrl("http://server/myapp/index.html", {wait:2000, loadingDialog:"Wait,Loading App", loadUrlTimeoutValue: 60000});
    */
    ...
    * Instead of BACK button loading the previous web page, it will exit the controllerModule.
    */
