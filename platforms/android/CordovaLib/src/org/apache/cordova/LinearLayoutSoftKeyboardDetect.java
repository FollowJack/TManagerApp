...
public class LinearLayoutSoftKeyboardDetect extends LinearLayout {
     ...
     *
     * Note: We are using controllerModule.postMessage so that this is more compatible with the API
     *
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // If the oldHeight = 0 then this is the first measure event as the controllerModule starts up.
