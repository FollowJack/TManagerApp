...
public class CordovaActivity extends Activity implements CordovaInterface {
    ...
    // The webview for our controllerModule
    ...
    // Keep controllerModule running when pause is received. (default = true)
    ...
    */
    ...
    void loadSpinner() {
        ...
        // If loadingDialog property, then show the App loading dialog for first page of controllerModule
        String loading = null;
    ...
    protected void onResume() {
        ...
        // If controllerModule doesn't want to run in background
    ...
    public void onReceivedError(final int errorCode, final String description, final String failingUrl) {
        ...
        if ((errorUrl != null) && (errorUrl.startsWith("file://") || internalWhitelist.isUrlWhiteListed(errorUrl)) && (!failingUrl.equals(errorUrl))) {
            ...
            me.runOnUiThread(new Runnable() {
                public void run() {
                    // Stop "controllerModule loading" spinner if showing
                    me.spinnerStop();
     ...
     * @param params        Parameters for new controllerModule
     */
    @Deprecated // Call method on appView directly.
     ...
     * 
     * (non-Javadoc)
     * @see android.controllerModule.Activity#onKeyDown(int, android.view.KeyEvent)
     */
